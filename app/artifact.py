...
class Artifact:
    ...
    @staticmethod
    def getMainStatKeys():
        return ['mainhpraw','mainatkraw','mainhpperc','maindefperc','mainer',
                'mainem','maincritrate','maincritdmg']
    
    @staticmethod
    def getSubStatKeys():
        return ['atkraw','atkperc','hpraw','hpperc','critrate','critdmg',
                'em','er','defraw','defperc']
